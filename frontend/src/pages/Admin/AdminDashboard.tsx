...
export default function AdminDashboard() {
  ...
  return (
    <div className="admin-shell">
      ...
      {/* Sidebar */}
      <aside className={sidebarOpen ? 'admin-sidebar open' : 'admin-sidebar'} style={{ width: '232px', background: 'var(--bg-surface)', borderRight: '1px solid var(--bd)', display: 'flex', flexDirection: 'column', position: 'fixed', height: '100vh', zIndex: 80, top: 0 }}>
